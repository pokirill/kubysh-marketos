...
| 5 | старый 03 (траты со скриншота), готовый кадр | оставить как есть | «Кинул скриншот, траты разложились сами» |
| 6 | новый `16.28.27` («Прикинуть покупку») | Могу ли я себе это позволить? | Введи сумму и сразу увидишь, откуда деньги и сколько останется на день |
| 7 | старый 10 (виджет), готовый кадр | оставить как есть | «Запас в днях, не открывая приложение» |
| 8 | старый 08 («Мелкие покупки»), готовый кадр | оставить как есть | «Что надо купить, не в голове, а в плане» |

| 9 | новый `16.02.11` (кредиты и сплиты) | Ипотека и сплиты учтены | Обязательные платежи заложены в план заранее, лимит на день честный |

Лимит стора — до 10 кадров, используем 9. Новый `16.25.01` (распознавание) не
брать: на кадре личные данные (УИН штрафов, Госуслуги) и «Нужна проверка / Другое».
Кадр 1: подпись «Хватит считать в уме: …» — сохраняет крючок набора 1.5/1.6 («48% прикидывают в голове»).
Комплект для дизайнера с ТЗ: `Кубыш доки и артефакты/Скрины 1.6.1 итог/` (01…09 + `ТЕКСТЫ_И_БРИФ.md`).
