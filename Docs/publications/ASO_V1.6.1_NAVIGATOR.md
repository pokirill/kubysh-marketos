...
Запас: новый `16.02.11` (кредиты и сплиты) — «Ипотека и сплиты учтены». Новый `16.25.01` (распознавание) не
...
Комплект для дизайнера с ТЗ: `Кубыш доки и артефакты/Скрины 1.6.1 итог/` (01…08 + `ТЕКСТЫ_И_БРИФ.md`).
